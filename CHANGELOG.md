...
- Home shows what is playing in your other apps and devices on the same account, like Feishin on the computer, with a button to carry on here from where it was, on Navidrome and other OpenSubsonic servers. Settings > Appearance turns it off.
