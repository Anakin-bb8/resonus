...
- The row under the player controls has lyrics, playback speed (now on by default), sleep timer and an equalizer that does nothing yet, next to devices and the queue; the sleep timer shows the minutes left.
