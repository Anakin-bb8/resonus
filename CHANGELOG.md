...
- Home shows its name in large type under the buttons, or the greeting when it is on, and it scrolls away with the page; Random songs is on and History is a chip instead of a button.
